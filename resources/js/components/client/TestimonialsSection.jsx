    ...
    const testimonials = [
        {
            ...
            location: 'Lahore',
            quote: 'SOLARKON transformed our energy consumption! Our bills are significantly lower, and the installation was smooth. The team was incredibly knowledgeable and guided us through every step.',
            rating: 5,
        ...
        },
        {
            ...
            location: 'Karachi',
            quote: "Switching to solar with SOLARKON was the best decision for our company. We've seen significant cost savings and our customers appreciate our commitment to sustainability. The ROI has been excellent!",
            rating: 5,
        ...
        },
        {
            ...
            location: 'Islamabad',
            quote: 'The team at SOLARKON made the entire process seamless. From consultation to installation, everything was handled professionally. Our property value has increased significantly, and maintenance is hassle-free.',
            rating: 5,
        ...
        },
        {
            ...
            title: 'Homeowner',
            location: 'Faisalabad',
            quote: "Excellent service from start to finish! SOLARKON helped us choose the perfect system for our home. The installation was quick, and we're already seeing great savings on our electricity bills.",
            rating: 5,
    ...
    return (
        ...
        >
            <div className="container">
                {/* Section Heading */}
                <motion.div className="mb-5 text-center" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                    <span
                        style={{
                            color: '#4ade80',
                    ...
                    <h2 style={{ fontSize: '2.3rem', color: '#ecfdf5', fontWeight: 700, marginTop: '1rem' }}>What Our Clients Say</h2>
                    <p style={{ color: '#bbf7d0', maxWidth: '600px', margin: '0.5rem auto 0' }}>
                ...
                <div className="position-relative" style={{ padding: '0 60px' }}>
                    ...
                    >
                        {testimonials.map((item, index) => (
                            ...
                            <SwiperSlide key={index} className="pb-5 pt-3 px-2 d-flex h-auto">
                                <motion.div
                                        ...
                                        <div>
                                            ...
                                            <p
                                                style={{
                                                    ...
                                                    lineHeight: 1.6,
                                                    fontSize: '1.0rem',
                                                    WebkitLineClamp: 2 /* 👈 change to 4 or 5 */,
                                                }}
                                            >
                                                "{item.quote}"
                                            </p>
