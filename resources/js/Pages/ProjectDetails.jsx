...
import { FaArrowLeft, FaCalendarAlt, FaExpand, FaMapMarkerAlt, FaSolarPanel, FaSpinner, FaTag, FaTimes } from 'react-icons/fa';
    ...
    if (!project) {
        return (
            <div className="min-vh-100 d-flex flex-column align-items-center justify-content-center">
                ...
                <Link href="/projects" className="btn btn-outline-success mt-3">
                    Back to Projects
                </Link>
            </div>
        );
    ...
    return (
        <div className="min-vh-100 d-flex flex-column bg-white">
            ...
            <main className="flex-grow-1">
                ...
                <section
                    className="position-relative d-flex align-items-end justify-content-center text-white pb-5 text-center"
                ...
                >
                    ...
                    <div className="position-relative z-2 container">
                        <Link
                            href="/projects"
                            className="btn btn-sm btn-light rounded-pill mb-4 px-3 fw-bold shadow-sm border-0"
                            style={{ opacity: 0.9 }}
                        >
                        ...
                        <span
                            className="d-block text-uppercase fw-bold text-warning mb-2 letter-spacing-2"
                            style={{ letterSpacing: '2px', textShadow: '0 2px 4px rgba(0,0,0,0.5)' }}
                        >
                            {project.tag}
                        </span>

                        <h1 className="display-3 fw-bold mb-4" style={{ textShadow: '0 2px 10px rgba(0,0,0,0.5)' }}>
                            {project.title}
                        </h1>
                    ...
                    <div className="container">
                        <div className="row g-5 align-items-start">
                            ...
                            <div className="col-lg-8 d-flex flex-column gap-5">
                                ...
                                {project.overview && (
                                    <section data-aos="fade-up">
                                        <h2 className="h4 fw-bold mb-3" style={{ color: '#022c22' }}>
                                            Overview
                                        </h2>
                                        <p style={{ fontSize: 18, lineHeight: 1.8, color: '#4B5563', whiteSpace: 'pre-line' }}>{project.overview}</p>
                                    </section>
                                )}
                                        ...
                                        <ul className="list-group list-group-flush" style={{ fontSize: 17, color: '#4B5563' }}>
                                            {executionPoints
                                                ...
                                                .map((point, index) => (
                                                    <li
                                                        key={index}
                                                        className="list-group-item ps-0 d-flex align-items-start py-2 border-0 bg-transparent"
                                                    >
                                ...
                                {impactData.length > 0 && (
                                    <section data-aos="fade-up">
                                        <h2 className="h4 fw-bold mb-4" style={{ color: '#022c22' }}>
                                            Project Impact
                                        </h2>
                                        <div className="row g-4">
                                            {impactData.map((item, index) => (
                                                <div key={index} className="col-md-6">
                                                    <div className="p-4 rounded-4 bg-light h-100 border-light shadow-sm border">
                                                        <div className="d-flex align-items-baseline gap-2 mb-1">
                                                            <h3 className="fw-bold text-success mb-0">{item.value}</h3>
                                                        </div>
                                                        <p className="fw-bold text-dark text-uppercase small mb-2" style={{ letterSpacing: '1px' }}>
                                                            {item.title}
                                                        </p>
                            ...
                            <div className="col-lg-4">
                                <div
                                    className="card shadow-sm rounded-4 p-4 sticky-top border-0"
                                    style={{ top: '100px', backgroundColor: '#f8faf9' }}
                                >
                                    <h5 className="fw-bold mb-4 pb-2 border-bottom" style={{ color: '#022c22' }}>
                                        Project Info
                                    </h5>
                                    ...
                                    <div className="d-flex flex-column gap-4">
                                        <div className="d-flex align-items-start gap-3">
                                            <div
                                                className="bg-white p-2 rounded-circle shadow-sm text-success"
                                                style={{ width: 40, height: 40, display: 'grid', placeItems: 'center' }}
                                            >
                                                <FaSolarPanel />
                                            </div>
                                            <div>
                                                <small className="text-uppercase text-muted fw-bold" style={{ fontSize: '11px' }}>
                                                    Service Type
                                                </small>
                                        ...
                                        <div className="d-flex align-items-start gap-3">
                                            ...
                                            <div className="d-flex flex-column">
                                                ...
                                                <div className="mt-1">
                                                    <span
                                                        className={`badge rounded-pill px-3 py-2 ${project.status === 'Completed' ? 'bg-success' : 'bg-warning text-dark'}`}
                                                    >
                                                        {project.status}
                                                    </span>
                                                </div>
                    ...
                    <section className="py-5 bg-white border-top">
                        <div className="container">
                            <div className="mb-5 text-center">
                                <h3 className="h2 fw-bold" style={{ color: '#022c22' }}>
                                    Project Gallery
                                </h3>
                                <div className="bg-success mt-3 mx-auto" style={{ width: '60px', height: '4px' }}></div>
                            </div>
                            ...
                            <div className="row g-4">
                                {galleryImages.map((img, index) => (
                                    <div key={index} className="col-md-6 col-lg-4 col-12">
                                        <div
                                            className="ratio ratio-4x3 rounded-4 shadow-sm position-relative gallery-card cursor-pointer overflow-hidden"
                                        ...
                                        >
                                            ...
                                            {/* Hover Overlay */}
                                            <div
                                                className="gallery-overlay position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center opacity-0"
            ...
            {lightboxImage && (
                ...
                >
                    <button className="position-absolute top-0 end-0 m-4 btn btn-link text-white p-0" onClick={() => setLightboxImage(null)}>
                        <FaTimes size={40} />
                    </button>
                    <img
                        src={lightboxImage}
